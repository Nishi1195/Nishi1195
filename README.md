...
<p align="center">
  <img src="https://readme-typing-svg.herokuapp.com?color=E8A0BF&size=24&center=true&vCenter=true&width=600&lines=Building+Beautiful+Web+Experiences;Exploring+Machine+Learning;Passionate+Problem+Solver;Learning+Something+New+Everyday+✨" />
</p>
...
```javascript
const nishi = {
  education: "B.Tech CSE - Adani University",
  currentlyLearning: ["Machine Learning", "React", "Advanced DSA"],
  skills: ["HTML", "CSS", "JavaScript", "Python", "React", "Node.js"],
  interests: ["AI", "Web Development", "Creative Design"]
};

🌷 Crafting responsive and user-friendly websites
🌱 Growing step-by-step in Machine Learning
...
## 🎀 Tech Stack
<p align="center"> 
  <img src="https://skillicons.dev/icons?i=html,css,js,react,python,nodejs,git,github,vscode,c&theme=light" /> 
</p>
